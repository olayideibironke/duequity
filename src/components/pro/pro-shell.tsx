 ...
 * DUEQUITY PRO SHELL
 *
 * Dense command-center navigation for the internal Duequity workflow.
 *
 * Navigation follows operational sequence:
 *
 *   Pipeline
 *   Work
 *   Governance
...
export function ProShell({
      ...
      items: [
        {
          ...
          badge: counts.tasksOverdue || undefined,
...

        {
          ...
          badge: counts.documentsOutstanding || undefined,
...

    {
      ...
      items: [
...

        {
          ...
          badge: counts.complianceBlocked || undefined,
  ...
  return (
    <div className="flex min-h-full">
      <a href="#pro-main" className="skip-link">
      ...
      >
        <div className="flex h-14 shrink-0 items-center justify-between gap-2 border-b border-ink-800 px-4">
          <Logo tone="light" size="sm" href="/pro" />
        ...
        <div className="shrink-0 border-t border-ink-800 p-3">
          <div className="flex items-center gap-2.5">
            ...
            <div className="min-w-0">
              ...
              <p className="truncate text-2xs text-ink-500">{operator.title}</p>
            </div>
          </div>

          <p className="mt-2 text-2xs text-ink-600">
            {operator.statesCleared.length === 0
              ? "Cleared nationally"
