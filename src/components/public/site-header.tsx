 ...
 *
 * Public visitors may learn about DueQuity and sign in to an existing claimant
 * or staff account.
 *
 * Property checking, surplus discovery and operational research are staff-only
 * capabilities and are intentionally not exposed through the public header.
 *
